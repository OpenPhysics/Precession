 ...
 * SimPanel.ts
 *
 * A pre-themed Panel that automatically uses RigidBodyPrecessionColors for background and
...
import { PANEL_CORNER_RADIUS } from "../RigidBodyPrecessionConstants.js";

export class SimPanel extends Panel {
  public constructor(content: Node, providedOptions?: PanelOptions) {
    super(content, {
      fill: RigidBodyPrecessionColors.panelBackgroundColorProperty,
