...
const REPLACEMENTS: ReadonlyArray<[string, string]> = [
  ...
  ["RigidBodyPrecessionScreenSummaryContent", `${newPrefix}ScreenSummaryContent`],
  ["RigidBodyPrecessionKeyboardHelpContent", `${newPrefix}KeyboardHelpContent`],
  ["RigidBodyPrecessionPreferencesModel", `${newPrefix}PreferencesModel`],
  ["RigidBodyPrecessionPreferencesNode", `${newPrefix}PreferencesNode`],
  ["RigidBodyPrecessionScreenView", `${newPrefix}ScreenView`],
  ["RigidBodyPrecessionColors", `${newPrefix}Colors`],
  ["RigidBodyPrecessionNamespace", `${newPrefix}Namespace`],
  ["RigidBodyPrecessionScreen", `${newPrefix}Screen`],
  ["RigidBodyPrecessionModel", `${newPrefix}Model`],
  // camelCase identifier
  ["rigidBodyPrecessionQueryParameters", `${newCamel}QueryParameters`],
  // Display strings
  ["Rigid Body Precession", newName],
  // Kebab identifiers (path segments and package name)
  ["precession", newId],
  ["precession-screen", `${newId}-screen`],
];
...
console.log(`  id:     precession → ${newId}`);
console.log(`  name:   Rigid Body Precession → ${newName}`);
